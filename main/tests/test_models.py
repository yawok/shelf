...
class TestBasket(TestCase):
    def test_create_order_works(self):
        p1 = models.Product.objects.create(name="A tale of 2 cities", price=Decimal("33.5"))
        p2 = models.Product.objects.create(name="Cell", price=Decimal("24.00"))
        user = models.User.objects.create_user(email="user@example.com", password="1randomDud6")
